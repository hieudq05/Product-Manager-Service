...
import com.pms.dao.Products_Export_DAO;
...
public class XuatHang extends javax.swing.JFrame {
    ...
    Products_Export_DAO exportdao=new Products_Export_DAO();
    JFileChooser filechooser = new JFileChooser();
    int row=0;
    int rowSellected;
    Date ngayNhapDangThaoTac;
    String nguoiNhapDangThaoTac;
    ...
    void edit() {
        ...
        file = new File(tblHangHoa.getValueAt(rowSellected, 3).toString());
        lblMaHang.setText(tblHangHoa.getValueAt(rowSellected, 0).toString());
        lblTenHang.setText(tblHangHoa.getValueAt(rowSellected, 1).toString());
        txtSoLuongNhap.setText("");
        txtGhiChu.setText("");
        lblImage.setText("");
        lblIdDangThaoTac.setText("<ID>");
        int newHeight = (lblImage.getWidth() * new ImageIcon(tblHangHoa.getValueAt(rowSellected, 3).toString()).getImage().getHeight(null)) / new ImageIcon(tblHangHoa.getValueAt(rowSellected, 3).toString()).getImage().getWidth(null);
        Image img = new ImageIcon(tblHangHoa.getValueAt(rowSellected, 3).toString()).getImage().getScaledInstance(lblImage.getWidth(), newHeight, Image.SCALE_SMOOTH);
    ...
    void xuathang(){
        try {
            // Thêm bản ghi lịch sử xuất hàng
            Products_Export exportHistory = new Products_Export();
            exportHistory.setMaHang(lblMaHang.getText());
            exportHistory.setNgayXuat(new Date()); // Lấy thời gian hiện tại
            exportHistory.setSoLuong(Integer.valueOf(txtSoLuongNhap.getText()));
            exportHistory.setNguoiXuat(maNV); // Giả định người nhập hàng
            exportdao.insert(exportHistory); // Lưu vào database
    ...
    private void initComponents() {
        ...
        btnXuatHangSubmit = new javax.swing.JButton();
        ...
        btnXuatHangSubmit.setBackground(new java.awt.Color(202, 233, 255));
        btnXuatHangSubmit.setFont(new java.awt.Font("Montserrat", 1, 14)); // NOI18N
        btnXuatHangSubmit.setForeground(new java.awt.Color(0, 102, 204));
        btnXuatHangSubmit.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/pms/icon/download_line.png"))); // NOI18N
        btnXuatHangSubmit.setText("Xuất hàng");
        btnXuatHangSubmit.setBorder(null);
        btnXuatHangSubmit.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        btnXuatHangSubmit.setIconTextGap(10);
        btnXuatHangSubmit.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnXuatHangSubmitActionPerformed(evt);
            }
        });
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        ...
                        .addComponent(btnXuatHangSubmit, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(63, 63, 63)))
                .addComponent(btnXuatHangSubmit, javax.swing.GroupLayout.PREFERRED_SIZE, 46, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        tblLichSu.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Mã hàng", "Ngày xuất", "Người xuất", "Số lượng", "Ghi chú"
            }
        ) {
            boolean[] canEdit = new boolean [] {
        ...
        jLabel2.setText("Lịch sử xuất hàng:");
    ...
    private void btnXuatHangSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXuatHangSubmitActionPerformed
        if(lblIdDangThaoTac.getText().equals("<ID>")==false){
            JOptionPane.showMessageDialog(this, "Làm mới Form trước khi xuất hàng!", "Thông báo", JOptionPane.INFORMATION_MESSAGE);
        } else {
            if(lblMaHang.getText().equals("<Mã hàng>")){
                JOptionPane.showMessageDialog(this, "Chọn hàng cần xuất kho!", "Thông báo", JOptionPane.INFORMATION_MESSAGE);
            } else {
    ...
    }//GEN-LAST:event_btnXuatHangSubmitActionPerformed
        ...
        if(lblIdDangThaoTac.getText().equals("<ID>")){
            ...
            if(txtSoLuongNhap.getText().isEmpty()){
                ...
                if(txtSoLuongNhap.getText().matches("^\\d+$")==false){
                    ...
                    Products_Export products_Export = new Products_Export();
                    products_Export.setID(Integer.valueOf(lblIdDangThaoTac.getText()));
                    products_Export.setMaHang(lblMaHang.getText());
                    products_Export.setNgayXuat(ngayNhapDangThaoTac);
                    products_Export.setNguoiXuat(nguoiNhapDangThaoTac);
                    products_Export.setSoLuong(soLuongHang);
                    products_Export.setGhiChu(txtGhiChu.getText());
                    exportdao.update(products_Export);
                    fillLichSuTable();
                    filltable();
    ...
    private javax.swing.JButton btnXuatHangSubmit;
    private javax.swing.JLabel jLabel1;
